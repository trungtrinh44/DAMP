...
def _register(get_config):
    ...
    if "Mixer" not in name and name not in (
        "testing",
        "ViT-L_32",
        "R50+ViT-B_16",
        "ViT-H_14",
...
def get_ti16_config():
    ...
    config.transformer.pos_emb_type = "learn"
    config.classifier = "token"
    config.representation_size = None
    return config
...
@_register
def get_s1k16_config():
    """Returns the ViT-S1k/16 configuration."""
    config = get_s16_config()
    config.model_name = "ViT-S1k_16"
    config.transformer.pos_emb_type = "sincos2d"
...
@_register
def get_b1k16_config():
    """Returns the ViT-B1k/16 configuration."""
    config = get_b16_config()
    config.model_name = "ViT-B1k_16"
    config.transformer.pos_emb_type = "sincos2d"
    config.classifier = "gap"
    return config
...
@_register
def get_l1k16_config():
    """Returns the ViT-B1k/16 configuration."""
    config = get_l16_config()
    config.model_name = "ViT-L1k_16"
    config.transformer.pos_emb_type = "sincos2d"
    config.classifier = "gap"
    config.transformer.dropout_rate = 0.0
    config.transformer.attention_dropout_rate = 0.0
